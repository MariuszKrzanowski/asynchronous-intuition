...
{
    public class SomethingHaveToDoServiceWithoutAsync : ISomethingHaveToDoService
    {
        private readonly ServiceType _serviceType;

        public SomethingHaveToDoServiceWithoutAsync(ServiceType serviceType)
        {
            _serviceType = serviceType;
        }

        public Task<decimal> DownloadSomeDecimal()
        {
